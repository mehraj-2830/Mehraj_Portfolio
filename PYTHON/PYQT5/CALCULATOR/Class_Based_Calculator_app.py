...
#importing all the necessary libraries for our Calculator app
...
#creating the main class for the calculator app
class Calculator(QWidget):
    def __init__(self): 
        super().__init__() #inheriting from the super class QWidget
        ...
        # Creating Buttons for the calculator. using grid layout for the buttons.
        ...
        # Extra Buttons for functionality 
    ...
    #Creating the function that will do the math 
...
#Styling the main window for fresher User Interface
